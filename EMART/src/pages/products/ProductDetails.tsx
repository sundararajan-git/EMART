...
export const products = [
  ...
  },
  {
    ...
    reviews: 86,
    description:
      "Premium extra virgin olive oil imported from Italy. Cold-pressed and 100% organic.",
    quantity: 1,
    sizes: ["250ml", "500ml", "1L"],
    isCart: false,
    images: [
      "https://images.unsplash.com/photo-1588167056547-c183313da36f?w=800",
    ],
  },
  {
    id: 3,
    ...
    reviews: 19,
    description:
      "Freshly baked whole wheat bread, soft inside with a crunchy crust. No preservatives.",
    quantity: 1,
    sizes: ["Single Pack", "Family Pack"],
    isCart: false,
    images: ["https://images.unsplash.com/photo-1542834369-f10ebf06d3e0?w=800"],
  },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <div className="mt-8 flex items-center gap-4">
            ...
            <Button
              onClick={handleAddToCart}
              className="w-fit flex items-center justify-center gap-2 rounded-sm bg-primary text-black cursor-pointer"
            >
